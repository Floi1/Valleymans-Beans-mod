...
public class LuckybeansblockBlock extends ValleymanBeansModElements.ModElement {
	@ObjectHolder("valleyman_beans:luckybeansblock")
	public static final Block block = null;

	public LuckybeansblockBlock(ValleymanBeansModElements instance) {
		super(instance, 94);
	}
