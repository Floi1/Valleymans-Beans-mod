...
public class ProcedureValleymansbeansthattasteone extends ElementsValleymanBeansMod.ModElement {
	public ProcedureValleymansbeansthattasteone(ElementsValleymanBeansMod instance) {
		super(instance, 21);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!world.isRemote) {
			EntityItem entityToSpawn = new EntityItem(world, x, y, z, new ItemStack(ItemValleymansbeansthattaste.block, (int) (1)));
