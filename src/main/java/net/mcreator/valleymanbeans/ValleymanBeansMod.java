 ...
 *
 *    Keep the ElementsValleymanBeansMod object in this class and all calls to this object
...
public class ValleymanBeansMod {
	...
	@Mod.Instance(MODID)
	public static ValleymanBeansMod instance;
	public ElementsValleymanBeansMod elements = new ElementsValleymanBeansMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsValleymanBeansMod.GuiHandler());
