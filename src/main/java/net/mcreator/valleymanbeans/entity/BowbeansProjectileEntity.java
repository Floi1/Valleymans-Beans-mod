...
public class BowbeansProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public BowbeansProjectileEntity(EntityType<? extends BowbeansProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public BowbeansProjectileEntity(EntityType<? extends BowbeansProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static BowbeansProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BowbeansProjectileEntity entityarrow = new BowbeansProjectileEntity(ValleymanBeansModEntities.BOWBEANS_PROJECTILE.get(), entity, world, null);
	...
	public static BowbeansProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		BowbeansProjectileEntity entityarrow = new BowbeansProjectileEntity(ValleymanBeansModEntities.BOWBEANS_PROJECTILE.get(), entity, entity.level(), null);
