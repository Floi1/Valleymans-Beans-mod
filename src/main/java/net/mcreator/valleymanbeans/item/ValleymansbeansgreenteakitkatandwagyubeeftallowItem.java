...
public class ValleymansbeansgreenteakitkatandwagyubeeftallowItem extends ValleymanBeansModElements.ModElement {
	@ObjectHolder("valleyman_beans:valleymansbeansgreenteakitkatandwagyubeeftallow")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Valleymans beans green tea kitkat and wagyu beef tallow"));
		}
