...
public class ValleymansbeansSeafoodpizzaandchocomilkItem extends Item {
	public ValleymansbeansSeafoodpizzaandchocomilkItem() {
		super(new Item.Properties().tab(ValleymanBeansModTabs.TAB_BEANS).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(10).saturationMod(10f).alwaysEat()
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Valleymans beans - Seafood pizza and choco milk"));
	}
