...
public class ValleymansbeansavocadoandchocolatechipsItem extends ValleymanBeansModElements.ModElement {
	@ObjectHolder("valleyman_beans:valleymansbeansavocadoandchocolatechips")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Valleymans beans avocado and chocolate chips (dont eat this near your base)"));
		}
