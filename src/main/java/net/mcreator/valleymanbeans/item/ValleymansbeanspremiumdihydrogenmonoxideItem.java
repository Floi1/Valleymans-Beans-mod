...
public class ValleymansbeanspremiumdihydrogenmonoxideItem extends ValleymanBeansModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
			...
			ValleymansbeanspremiumdihydrogenmonoxideEntitySwingsItemProcedure
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			ValleymansbeanspremiumdihydrogenmonoxideFoodEatenProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
