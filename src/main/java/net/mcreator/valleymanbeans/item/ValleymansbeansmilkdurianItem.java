...
public class ValleymansbeansmilkdurianItem extends Item {
	public ValleymansbeansmilkdurianItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.valleyman_beans.valleymansbeansmilkdurian.description_0"));
	}
