...
public class ValleymansbeansmintandlicoriceItem extends Item {
	public ValleymansbeansmintandlicoriceItem() {
		super(new Item.Properties().tab(ValleymanBeansModTabs.TAB_BEANS).stacksTo(64).rarity(Rarity.RARE).food((new FoodProperties.Builder()).nutrition(1).saturationMod(0f).alwaysEat()
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Valleymans beans mint and licorice"));
	}
