...
public class ValleymansbeansaustraliaItem extends Item {
	public ValleymansbeansaustraliaItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.valleyman_beans.valleymansbeansaustralia.description_0"));
	}
