...
public class ValleymansbeansVeteransDayspecialItem extends Item {
	public ValleymansbeansVeteransDayspecialItem() {
		super(new Item.Properties().tab(ValleymanBeansModTabs.TAB_BEANS).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(20).saturationMod(6f).alwaysEat()
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Valleymans beans Veterans Day special"));
	}
