...
public class ValleymansbeanspremiumItem extends Item {
	public ValleymansbeanspremiumItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.valleyman_beans.valleymansbeanspremium.description_0"));
	}
