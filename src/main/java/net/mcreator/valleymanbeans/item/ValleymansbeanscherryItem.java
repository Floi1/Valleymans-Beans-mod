...
public class ValleymansbeanscherryItem extends Item {
	public ValleymansbeanscherryItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.valleyman_beans.valleymansbeanscherry.description_0"));
	}
